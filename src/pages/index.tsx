  ...
  return (
    <Box className={HomeStyles.main}>
      ...
      <Typography variant='caption'
        color={'#555'}
      >
        Caso não preencha nenhuma informação, trará o clima atual de São Paulo.
      </Typography>
      <Typography variant='caption'
        color={'#555'}
      >
        Caso não seja encontrada a cidade, trará a capital do Estado
      </Typography>
      <WeatherBox
        cityName={cityName}
